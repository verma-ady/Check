...
public class webview extends Fragment {
    ...
    void go(){
        button = (Button) view.findViewById(R.id.button_webview);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                webView = (WebView) view.findViewById(R.id.webView);
                textView = (TextView) view.findViewById(R.id.text_webView);
                ...
                webView.loadUrl("http://docs.google.com/gview?embedded=true&url=http://www.pc-hardware.hu/PDF/konfig.pdf");
